...
#define UART_MODE 4
#define STEP_US 830   // 每一步的时间间隔，用于调整电机速度，800~1500微秒
...
inline void stepForward(int dir) {
  PORTB = (PORTB & 0b11110000) | stepTable[stepIndex];
